<template>
    <div class="inheritor-detail-container">
        <van-nav-bar :title="detailName" fixed placeholder :border="false" @click-left="onClickLeft">
            <template #left>
        ...
        <van-pull-refresh v-model="refreshing" @refresh="onRefresh">
            <div class="detail-page">
                ...
                <div class="info-panel">
                    ...
                    <div class="meta">
                        <div class="meta-row">
                            <span class="meta-label">性别：</span><span class="meta-value">{{ detail?.gender || '-'
                                }}</span>
                        </div>
                        <div class="meta-row">
                            <span class="meta-label">民族：</span><span class="meta-value">{{ detail?.nation || '-'
                            }}</span>
                        </div>
                        <div class="meta-row">
                            <span class="meta-label">出生日期：</span><span class="meta-value">{{ detail?.birthday || '-'
                            }}</span>
                        </div>
                        <div class="meta-row">
                        ...
                        <div class="meta-row">
                            <span class="meta-label">项目名称：</span><span class="meta-value">{{ detail?.projectName || '-'
                                }}</span>
                        </div>
                    </div>
...
const detail = ref<InheritorItem | null>(null)

const id = computed(() => String(route.query.id || ''))
const pageTitle = computed(() => String(route.query.title || '传承人'))
...
const fetchDetail = async () => {
    try {
        ...
        const response = await api.inheritor.getInheritorById(id.value)
